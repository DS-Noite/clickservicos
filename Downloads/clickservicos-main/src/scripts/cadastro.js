...
function handleCadastro(e) {
  ...
  // 🆕 1. CAPTURA O TELEFONE DO NOVO INPUT DO HTML
  ...
  /* Validação 1: Verifica se algum dos campos essenciais está vazio (Adicionado 'telefone') */
  ...
  const novoUsuario = {
    ...
    email,
    senha,
    telefone, // 🆕 2. ADICIONA O TELEFONE SALVO DENTRO DO PERFIL DO USUÁRIO
  ...
  /* Salva o usuário recém-criado na sessão (o que distribui os dados para a Home e o Painel) */
